...
\section{Bakgund} 	
	...
	\subsection{Scrum i korthet}	
		...
		Inför varje sprint hålls en sprint-planering.
...
\section{Resultat}
	...
	\subsection{Användningsområden}
		...
		Ramverk som favoriserats av en specifik branch kan antas vara väl mer lämpat för ett dylikt företag än de andra ramverken.
