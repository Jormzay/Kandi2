...
\section{Analys, fallstudier och resultat}
	...
	\subsection{Large-Scale Scrum}
		...
		Large-Scale Scrum har som grundläggande egenskap Scrum. Scrum-grupper håller egna interna scrum-möten med scrum-mästare, och upprätthåller egna sprint-backloggar. Ovanpå den traditionella Scrum-metodiken existerar hela produktens logistik.
		\begin{center}	
